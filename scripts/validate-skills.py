#!/usr/bin/env python3
"""Validate plugin skill metadata and local markdown links.

Checks every plugin/skills/*/SKILL.md for:
- well-formed YAML frontmatter with `name` (== folder name) and `description`
- no `@skills/` references (use paths relative to SKILL.md)
